...
module.exports = function () {
	$('<div/>').addClass('my-box').html('webpack 引入第三方库。').appendTo($('body'));
	...
	var arrayInit = function arrayInit(arr) {
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/_css-loader@0.28.9@css-loader/index.js!../node_modules/_stylus-loader@3.0.1@stylus-loader/index.js!./module.styl", function() {
			var newContent = require("!!../node_modules/_css-loader@0.28.9@css-loader/index.js!../node_modules/_stylus-loader@3.0.1@stylus-loader/index.js!./module.styl");
